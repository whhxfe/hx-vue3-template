...
const detailRow = ref<RystListItem | null>(null)
...
// ==================== 表格数据 ====================
const tableData = ref<RystListItem[]>([])
...
const loadTableData = async () => {
	...
	try {
		...
		const res = await ryst.getList(query)
		tableData.value = (res.data?.list || []) as RystListItem[]
